...
- **"Nothing on this set threatens it back"** when none of that member's own real, already-chosen moves land super effective against the counter — a genuine wall, not just a hard hitter. A merely neutral hit doesn't clear the bar; a weak neutral move is exactly as much "no real answer" as a resisted one. Checked against the counter's own real defensive ability too (a Water Absorb holder genuinely blocks a Water move back), the same way the reasons above check the counter's own offense.
